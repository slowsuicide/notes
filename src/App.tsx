...
import {
  VersionProvider,
  usePageVersionContext,
} from "./components/context/VersionProvider";
...
// {versionInfo && (( versionInfo.version === 'mobile' && versionInfo.window === 'main') || versionInfo.version === 'desktop') && (
//   <MainNotes
//     currNote={currNote}
//     notes={notes}
//     onChangeCurrNote={onChangeCurrNote}
...
//   />
// )}
// {versionInfo && ((versionInfo.version === 'mobile' && versionInfo.window === 'description') || versionInfo.version === 'desktop') && (
//   <NoteInfo note={currNote} onChangeNote={onChangeNote} />)}
